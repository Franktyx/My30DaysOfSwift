...
SWIFT_CLASS("_TtC10CustomFont11AppDelegate")
...
SWIFT_CLASS("_TtC10CustomFont14ViewController")
...
@property (nonatomic, strong) UIButton * _Null_unspecified changeFontButton;
- (void)viewDidLoad;
- (void)changeFont:(UIButton * _Nonnull)sender;
